...
const TYPES = [
  { code:'M-01', title:'Private Refineries',  body:'Direct Allocations from selected private refineries in Asia and the USA, granting exclusive allocation rights and direct pricing access without intermediaries.' },
...
const ADVANTAGES = [
  { title:'Direct Access',    body:'Direct access to refineries and producers — no intermediaries, no opacity, no inflated costs.' },
...
export default function Mandate() {
  ...
  const seo = {
    title: 'Direct Allocations — Oil & Gas Mandate Structure | TCG',
    description: 'TCG operates under official mandates from private refineries, title holders, public refineries and global producers. Direct allocation, no resellers, no middlemen. Full KYC, AML compliance and legal contracts.',
    canonical: 'https://tcgglobal.us/allocations',
    ogImage: 'https://tcgglobal.us/img/og-allocations.jpg'
  }

  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Direct Allocations & Mandate Trading',
    ...
    termsOfService: 'FOB / CIF / TTO / TTV — delivery terms tailored to buyer requirements',
    hasOfferCatalog: {
      '@type': 'OfferCatalog',
      name: 'Mandate Types',
      ...
      <section className="page-hero">
        ...
        <div className="wrap page-hero-content">
          ...
          <h1 className="t-display page-hero-title" style={{animation:'slideUp .6s ease .1s both'}}>
            Direct <span className="gold">Allocations</span>
          </h1>
          ...
          <div className="cta-band" data-reveal>
            <div>
              <h3 className="t-display cta-band-h">
                Ready <span className="gold">to work?</span>
              </h3>
